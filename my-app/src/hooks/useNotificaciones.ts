...
export function useNotifications() {
  ...
  const fetchNotifications = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`https://copia-backend.vercel.app/api/notificaciones/dropdown-notificaciones/${userId}`);
  ...
  const fetchUnreadCount = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(`https://copia-backend.vercel.app/api/notificaciones/notificaciones-no-leidas/${userId}`);
      const data = await response.json();
  ...
  const markAsRead = useCallback(async (notificationId: string) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://copia-backend.vercel.app/api/notificaciones/notificacion-leida/${notificationId}/${userId}`,
        { method: 'PUT' }
      );
