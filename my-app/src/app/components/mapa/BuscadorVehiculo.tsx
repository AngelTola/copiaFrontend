...
export default function BuscadorVehiculo({
  ...
  const fetchHistorial = async () => {
    try {
      const url = textoBusqueda.trim()
        ? `https://integracion-back.vercel.app/api/autocompletar?usuarioId=${usuarioId}&texto=${textoBusqueda}`
        : `https://integracion-back.vercel.app/api/ultimas?usuarioId=${usuarioId}`;
  ...
  const registrarBusqueda = async () => {
    ...
    try {
      await fetch("https://integracion-back.vercel.app/api/registrar", {
        method: "POST",
